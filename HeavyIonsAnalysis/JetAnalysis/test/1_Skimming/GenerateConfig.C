                    ...
                    int fileLimit = 1)
{
    ...
    std::vector<std::pair<int,int>> jetCfg = {{2,1},{2,2},{2,3},{3,1},{3,2},{3,3},{4,1},{4,2},{4,3},{5,1},{5,2},{5,3},{6,1},{6,2},{6,3},{8,1},{8,2},{8,3}};  // Extend as needed
    for (auto& p: jetCfg) {
        treePaths.push_back({
            // Form("akCs%dPFJetAnalyzerSDZcut%d/t", p.first, p.second),
            Form("ak%dPFJetAnalyzerSDZcut%d/t", p.first, p.second),
