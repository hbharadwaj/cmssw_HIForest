...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        'root://cms-xrd-global.cern.ch//store/user/bharikri/Run3MC_PbPb/MINIAOD/2024_Mar_07_Pythia8_QCDPhoton30_Embedded_TuneCP5_13_2_10_LLR_MINIAODSIM/Pythia8_Embedded_QCDPhoton30_TuneCP5/2024_Mar_07_step4_MINIAODSIM_Pythia8_Embedded_QCDPhoton30_TuneCP5_13_2_10/240321_074241/0000/step4_1.root'
    ),
)
...
def readPhoRegresFromDBFile(process,filename=None,suffex="2023PbPb",prod=False):
    ...
    process.phoRegres = cms.ESSource("PoolDBESSource",CondDBReg,
                                     ...
                                     toGet = cms.VPSet(
        # Only register the photon regression that's available in our test DB
        cms.PSet(record = cms.string("GBRDWrapperRcd"),
                 label = cms.untracked.string("hin_photon_eb_1To500"),
                 tag = cms.string("hin_photon_eb_1To500_{}_private".format(suffex))),
                                     )
                                 )
    process.es_prefer_phoRegres = cms.ESPrefer("PoolDBESSource","phoRegres")
    return process

readPhoRegresFromDBFile(process,filename="/afs/cern.ch/user/b/bharikri/private/HeavyIon/run3_gamma_jet/CMSSW_13_2_13/src/HeavyIonsAnalysis/EGMAnalysis/data/20250515_test_2023PbPb_photon_regression.db",suffex="2023PbPb")
# readPhoRegresFromDBFile(process,suffex="2023PbPb")

from RecoEgamma.EgammaTools.regressionModifier_cfi import regressionModifier132XHIN
...
egamma_modifications.append(regressionModifier132XHIN)
